...
(1).Linux kernel must be larger than 6.5.0 (My O/S: Ubuntu 23.10,kernel:6.5.0-9)
(2).Download Linux update firmware from https://git.kernel.org/pub/scm/linux/kernel/git/firmware/linux-firmware.git/
(3).Unzip
